 ...
 *      CREATE TOKEN
 * ---------------------------
 * 1.client: afer user login send user basic info to create token
 * 2. in the server side: install npm i jsonwebtoken
 * 3. import jsonwebtoken
 * 4. jwt.sign(payload, secret, {expires})
 * 5. return token to the client side
 * 
 * 6. after receiving the token store it either httponly cookies or localstorage (scond best solution)
 * 
 ...
 * 7. if error => send 401
 * 8. set decoded to the req objectso that we can retrieve it later
